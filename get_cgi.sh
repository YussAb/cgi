...
grep "^#" ccg.bed > ccg_sorted.bed
grep -v "^#" ccg.bed | sort -k1,1V -k2,2g >> ccg_sorted.bed
bgzip ccg_sorted.bed

grep "^#"  onco_muts.bed > onco_muts_sorted.bed
grep -v "^#" onco_muts.bed | sort -k1,1V -k2,2g >> onco_muts_sorted.bed
bgzip onco_muts_sorted.bed


#Create an index, using tabix, of the zipped bed files
echo "Creating tabix indices of the BED files"
tabix -p bed ccg_sorted.bed.gz
tabix -p bed onco_muts_sorted.bed.gz
